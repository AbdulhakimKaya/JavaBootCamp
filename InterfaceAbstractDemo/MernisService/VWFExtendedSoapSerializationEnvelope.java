...
public class VWFExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(VWFDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new VWFStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static VWFDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static VWFDateTimeConverter dateTimeConverter = new VWFStandardDateTimeConverter();

    public VWFExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public VWFExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new VWFMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=VWFHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,VWFExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=VWFHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
