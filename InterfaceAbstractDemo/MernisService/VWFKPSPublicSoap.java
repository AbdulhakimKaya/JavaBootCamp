package HomeworkDay4.InterfaceAbstractDemo.MernisService;
...
public class VWFKPSPublicSoap
{


    interface VWFIWcfMethod
    {
        VWFExtendedSoapSerializationEnvelope CreateSoapEnvelope() throws java.lang.Exception;

        java.lang.Object ProcessResult(VWFExtendedSoapSerializationEnvelope __envelope,java.lang.Object result) throws java.lang.Exception;
    }
    ...
    public VWFKPSPublicSoap(){}

    public VWFKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public VWFKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    protected VWFExtendedSoapSerializationEnvelope createEnvelope()
    {
        VWFExtendedSoapSerializationEnvelope envelope= new VWFExtendedSoapSerializationEnvelope(VWFExtendedSoapSerializationEnvelope.VER11);
        envelope.enableLogging = enableLogging;
    
        return envelope;
    }

    protected java.util.List sendRequest(String methodName,VWFExtendedSoapSerializationEnvelope envelope,org.ksoap2.transport.Transport transport ,com.easywsdl.exksoap2.ws_specifications.profile.WS_Profile profile )throws java.lang.Exception
    {
    ...
    java.lang.Object getResult(java.lang.Class destObj,java.lang.Object source,String resultName,VWFExtendedSoapSerializationEnvelope __envelope) throws java.lang.Exception
    {
        if(source==null)
        {
            return null;
    ...
    public Boolean TCKimlikNoDogrula(final Long TCKimlikNo, final String Ad, final String Soyad, final int DogumYili) throws java.lang.Exception
    {
        ...
        return (Boolean)execute(new VWFIWcfMethod()
        {
            @Override
            public VWFExtendedSoapSerializationEnvelope CreateSoapEnvelope(){
                VWFExtendedSoapSerializationEnvelope __envelope = createEnvelope();
            ...
            @Override
            public java.lang.Object ProcessResult(VWFExtendedSoapSerializationEnvelope __envelope,java.lang.Object __result)throws java.lang.Exception {
    ...
    protected java.lang.Object execute(VWFIWcfMethod wcfMethod,String methodName,com.easywsdl.exksoap2.ws_specifications.profile.WS_Profile profile) throws java.lang.Exception
    {
        org.ksoap2.transport.Transport __httpTransport=createTransport();
        __httpTransport.debug=enableLogging;
        VWFExtendedSoapSerializationEnvelope __envelope=wcfMethod.CreateSoapEnvelope();
        try
        {
    ...
    protected java.lang.Exception convertToException(org.ksoap2.SoapFault fault,VWFExtendedSoapSerializationEnvelope envelope)
    {
