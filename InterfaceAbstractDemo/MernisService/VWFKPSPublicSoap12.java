...
public class VWFKPSPublicSoap12
{
    ...
    public VWFKPSPublicSoap12(){}

    public VWFKPSPublicSoap12(String url)
    {
        this.url = url;
    }

    public VWFKPSPublicSoap12(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        VWFExtendedSoapSerializationEnvelope envelope= new VWFExtendedSoapSerializationEnvelope(VWFExtendedSoapSerializationEnvelope.VER12);
