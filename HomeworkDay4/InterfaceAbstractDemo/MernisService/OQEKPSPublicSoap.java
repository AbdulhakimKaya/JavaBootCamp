...
public class OQEKPSPublicSoap
{
    ...
    public OQEKPSPublicSoap(){}

    public OQEKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public OQEKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        OQEExtendedSoapSerializationEnvelope envelope= new OQEExtendedSoapSerializationEnvelope(OQEExtendedSoapSerializationEnvelope.VER11);
