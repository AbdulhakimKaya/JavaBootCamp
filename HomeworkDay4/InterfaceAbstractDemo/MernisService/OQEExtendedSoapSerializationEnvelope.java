...
public class OQEExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(OQEDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new OQEStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static OQEDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static OQEDateTimeConverter dateTimeConverter = new OQEStandardDateTimeConverter();

    public OQEExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public OQEExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new OQEMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=OQEHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,OQEExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=OQEHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
